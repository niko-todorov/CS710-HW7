...
pal(rainbow_hcl(14, start = 270, end = 150), main = "cold")
pal(rainbow_hcl(14, start = 90, end = -30), main = "warm")

# Sequential Color Palettes
pal(sequential_hcl(12, c = 0, power = 2.2)) # BW
pal(sequential_hcl(12, power = 2.2)) # blue-white
pal(heat_hcl(12, c = c(80, 30), l = c(30, 90), power = c(1/5, 2))) #heat: magenta-yellow
pal(terrain_hcl(12, c = c(65, 0), l = c(45, 90), power = c(1/2, 1.5))) #terrain
